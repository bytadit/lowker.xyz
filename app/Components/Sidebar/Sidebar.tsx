...
import { arrowLeft, bars, logout, login } from "@/app/utils/Icons";
import { UserButton, useClerk, useUser } from "@clerk/nextjs";
function Sidebar({ isLogin }: { isLogin: boolean }) {
  ...
  return (
    <SidebarStyled theme={theme} collapsed={collapsed}>
      ...
      <div className="profile">
        ...
        {user ? (
          <div className="user-btn flex justify-center items-center">
            <UserButton />
          </div>
        ) : (
          <div className="image flex justify-center items-center">
            <Image width={40} height={40} src={imageUrl} alt="profile" />
          </div>
        )}
        {/* <div className="image">
